...
class OnionShareGui(QtGui.QWidget):
    ...
    def send_or_receive(self):
        ...
        response = QtGui.QMessageBox.question(self, "Message", prompt, QtGui.QMessageBox.Yes,
    ...
    def check_for_requests(self):
        ...
        for event in events:
            ...
            # TODO add upload done stuff
            elif event["path"] != '/favicon.ico':
                if event["path"] == '/send':
                    self.update_log(event, "Upload page has been loaded")  #TODO load from strigs.json
                elif event["path"] == '/send/function':
                    self.update_log(event, "Upload has started")
                else:
