...
class OnionShareGuiTest(unittest.TestCase):
    ...
    def test_start_server_again(self):
        '''Test that we can start the server again'''
    ...
    def test_same_onion_host(self):
        '''Test that the onion host is the same'''
        self.assertEqual(self.gui.app.onion_host, onion_host)

    @pytest.mark.run(order=9)
    def test_same_slug(self):
        '''Test that the slug is the same'''
