...
class SettingsDialogTest(unittest.TestCase):
    ...
    def test_shutdown_timer_checkbox_button_pressed(self):
        '''Test we can check the shutdown_timer checkbox'''
    ...
    def test_settings_found_in_json(self):
        ...
        self.assertTrue('"shutdown_timeout": true' in open('/tmp/settings.json').read())
