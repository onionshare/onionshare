...
class OnionShareGuiTest(unittest.TestCase):
    ...
    def test_web_page(self):
        '''Test that the web page looks right'''
        ...
        with open('/tmp/download', 'wb') as file_to_write:
            while True:
               data = s.recv(1024)
               if not data:
                   break
