...
class OnionShareGuiTest(unittest.TestCase):
    ...
    def test_url_description_shown(self):
        ...
        self.assertTrue(self.gui.server_status.url_description.isVisible())
        self.assertEquals(self.gui.server_status.url.text(), 'http://{0:s}/{1:s}'.format(self.gui.app.onion_host, self.gui.server_status.web.slug))
    ...
    def test_server_status_indicator_says_sharing(self):
        ...
        self.assertEquals(self.gui.server_status_label.text(), strings._('gui_status_indicator_started', True))
