...
class OnionShareGuiTest(unittest.TestCase):
    ...
    def test_web_page(self):
        ...
        http_request = 'GET {} HTTP/1.0\r\n'.format(self.gui.receive_mode.server_status.web.slug)
    ...
    def test_upload_file(self):
        ...
        response = requests.post('http://127.0.0.1:{}/{}/upload'.format(self.gui.app.port, self.gui.receive_mode.web.slug), files=files)
        QtTest.QTest.qWait(2000)
