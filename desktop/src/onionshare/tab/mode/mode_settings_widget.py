...
class ModeSettingsWidget(QtWidgets.QWidget):
    ...
    def __init__(self, common, tab, mode_settings):
        ...
        common_settings_layout = QtWidgets.QVBoxLayout()
        common_settings_layout.addWidget(self.persistent_checkbox)
        common_settings_layout.addWidget(self.public_checkbox)
        common_settings_layout.addWidget(self.advanced_widget)
        common_settings_layout.addWidget(self.toggle_advanced_button)
        common_settings_widget = QtWidgets.QWidget()
        common_settings_widget.setLayout(common_settings_layout)
        ...
        settings_scroll_area.setWidget(common_settings_widget)
